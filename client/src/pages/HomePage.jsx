...
const ProjectRow = ({ project: p, navigate, handleDelete }) => {
  ...
  return (
    <div
      ...
      className='bg-white/5 border border-white/10 rounded-lg px-4 py-3 flex items-center justify-between hover:border-white/20 hover:bg-white/10 cursor-pointer backdrop-blur-md transition-all'
    >
      ...
      <div className='flex items-center gap-2'>
        {hovered && (
          <button
            ...
            className='p-1.5 rounded-md text-zinc-200 hover:text-red-400 hover:bg-white/10 transition-colors'
          >
            <Trash2Icon size={14} />
          </button>
        )}
      ...
      <div className='flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8 xl:mt-28'>
        ...
        <div className='w-full max-w-2xl flex flex-col items-center'>
          ...
          <p className='text-center text-sm md:text-base max-w-xl mt-4 text-white/65 leading-relaxed'>
            Describe your idea and watch AI design, structure and launch your website instantly. No cooding required.
          </p>
